 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Js_Auth_Adapter_Doctrine implements Zend_Auth_Adapter_Interface
{
    /**
     * Database Connection
     *
    ...
    {
        try {
            $resultIdentities = $dbSelect->execute();
            $this->_resultIdentity = (count($resultIdentities) == 1) ? $resultIdentities[0] : $resultIdentities;
        } catch (Exception $e) {
            /**
             * @see Zend_Auth_Adapter_Exception
             */
        ...
        return $resultIdentities->toArray();
    }
    ...
    protected function _authenticateValidateResult($resultIdentity)
    {
        ...
        $this->_authenticateResultInfo['identity']   = $this->_resultIdentity;
        return $this->_authenticateCreateAuthResult();
    }
