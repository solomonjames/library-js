...
/**
 * Session Save handler for Doctrine 1.x ORM
 * 
 * @link   http://framework.zend.com/wiki/display/ZFPROP/Zend_Session_SaveHandler_Doctrine+-+Matthew+Lurz
 * @author James Solomon <james@jmsolomon.com>
 * @author Matthew Lurz <mlurz71@gmail.com>
 */
class Js_Session_SaveHandler_Doctrine implements Zend_Session_SaveHandler_Interface
{
    ...
    {
        $q = Doctrine::getTable($this->_tableName)->createQuery()
            ->delete()
